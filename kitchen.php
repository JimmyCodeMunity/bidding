...
<?php
        ...
        $cat = $row['category'];
        $query_command = "SELECT * FROM product WHERE sold = '1' && category = 'Kitchen Accessory' ";
    ...
    <?php
         ...
         echo '<div class="alert alert-danger" role="alert">No Kitchen ware to display</div>';
      }
...
<?php
        ...
        $cat = $row['category'];
        $query_command = "SELECT * FROM product WHERE sold = '0' && category = 'Kitchen Accessory' ";
    ...
    <?php
         ...
         echo '<div class="alert alert-danger" role="alert">No Kitchen accessories have been sold yet</div>';
      }
