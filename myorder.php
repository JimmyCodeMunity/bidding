...
<?php
        ...
        $cat = $row['category'];
        $query_command = "SELECT * FROM product WHERE sold = '0' && buyer = '$user' ";
      ...
      <div><strong> $<?php echo $row['price']?></strong></div>
        ...
        <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                ...
                if($row['pay_status']==1){
                  ...
                  echo "<a class='btn btn-small btn-primary' href='pay.php?id=".$row['id']."'>Pay</a>&nbsp;";;
    ...
    <?php
         ...
         echo '<div class="alert alert-danger" role="alert">You havent won any bid</div>';
      }
