...
<head>
  ...
  <title>Tangara|View product</title>
          ...
          <!-- Recent Sales -->
            <div class="col-12">
              ...
              while($row=mysqli_fetch_assoc($res)){?>
                   ...
                   <?php
                if($row['sold']==1){
                  echo "<a class='badge bg-success' href='?type=sold&operation=deactive&id=".$row['id']."'>Available</a>&nbsp;";
                }else{
                  echo "<a class='badge bg-warning' href='?type=sold&operation=active&id=".$row['id']."'>Sold</a>&nbsp;";
                }
                ?>
              </td>
              <td>
                <?php
                echo "<a class='btn btn-sm btn-primary' href='editteacher.php?id=".$row['id']."'>Edit</a>&nbsp;";
