...
if(isset($_POST['addsubject'])){
  ...
  $select = "SELECT * FROM classes WHERE classname = '$sub'";
  $res = mysqli_query($conn,$select);

  if(mysqli_num_rows($res) > 0){
    $error[] = 'Subject already saved';

  }
  else{
    $insert = "INSERT INTO subjects(subname)VALUES('$sub')";
    mysqli_query($conn,$insert);
    $error[] = '<div class="alert alert-success" role="alert">subject saved successfully</div>';
...
if(isset($_POST['addteacher'])){
  ...
  $select = "SELECT * FROM teachers WHERE email = '$email' && password ='$pass'";
  $res = mysqli_query($conn,$select);
  ...
  if(mysqli_num_rows($res)>0){
    ...
    if($pass != $rpass){
      ...
      $insert = "INSERT INTO teachers(fullname,idnumber,phone,dateadd,class,email,subject,password)VALUES('$lname','$reg','$phone','$added_on','$class','$email','$sub','$pass')";
      mysqli_query($conn,$insert);
    ...
    <section class="section">
      <div class="row">
        <div class="col-lg-9">
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Add subject first</h5>
            ...
            <div class="card-body">
              ...
              <form action="" method="POST">
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="idnum" maxlength="8">
                  </div>
                </div>
                <div class="row mb-3">
