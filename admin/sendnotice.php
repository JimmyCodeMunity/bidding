...
if(isset($_GET['id']) && $_GET['id']!=''){
  $image_required='';
  $id=$_GET['id'];
  $res=mysqli_query($conn,"select * from notice where id='$id'");
...
if(isset($_POST['send'])){
  ...
  $insert = "INSERT INTO notice(subject,message)VALUES('$subject','$msg')";
    ...
    <section class="section">
      <div class="row">
        <div class="col-lg-9">
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Create Notice/Memo</h5>
      ...
      ?>
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <textarea name="message" style="height:200px;width:500px;border-radius:25px;padding: 5px;background-color: lightgrey;color: black;"></textarea>
                  </div>
                </div>
          ...
          <!-- Recent Sales -->
            <div class="col" id="notice">
              <div class="card recent-sales overflow-auto">
                ...
                <div class="card-body">
                  <h5 class="card-title">Recent memos <span>| Today</span></h5>
              ...
              while($row=mysqli_fetch_assoc($res)){?>
                   ...
                   <?php
                if($row['status']==1){
                  echo "<a class='badge bg-success' href='?type=status&operation=deactive&id=".$row['id']."'>Available</a>&nbsp;";
                }else{
                  echo "<a class='badge bg-warning' href='?type=status&operation=active&id=".$row['id']."'>Unavailable</a>&nbsp;";
                }
                ?>
              </td>
              <td>
                <?php
                echo "<a class='btn btn-sm btn-primary' href='editstudent.php?id=".$row['id']."'>Edit</a>&nbsp;";
