...
$query = "SELECT * FROM pruduct WHERE sold = 0";
...
//count bookings
//$book = "SELECT count(*) FROM bookings";
//$countbk = mysqli_query($conn,$book);

//count students
$cl = "SELECT count(*) FROM product WHERE sold = 1";
  ...
  <header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <div class="d-flex align-items-center justify-content-between">
      <a href="index.php" class="logo d-flex align-items-center">
        ...
        <span class="d-none d-lg-block">OnlineBid</span>
      </a>
      ...
      <div class="row">
        ...
        <div class="col-lg-4">
          ...
          <div class="card">
            ...
            <div class="card-body">
              <h5 class="card-title">Recent Notifications <span>| Today</span></h5>
