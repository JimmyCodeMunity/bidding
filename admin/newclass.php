...
if(isset($_GET['type']) && $_GET['type']!=''){
  ...
  if($type=='status'){
    ...
    $update_status_sql="update classes set status='$status' where id='$id'";
...
if(isset($_POST['addclass'])){
  ...
  $select = "SELECT * FROM classes WHERE classname = '$class'";
  $res = mysqli_query($conn,$select);

  if(mysqli_num_rows($res) > 0){
    $error[] = 'class already saved';

  }
  else{
    $insert = "INSERT INTO classes(classname)VALUES('$class')";
    mysqli_query($conn,$insert);
    $error[] = '<div class="alert alert-danger" role="alert">class saved successfully</div>';
...
<body>
  ...
  <main id="main" class="main">
    ...
    <section class="section">
      ...
      <!-- Recent Sales -->
            <div class="col-12">
              <div class="card recent-sales overflow-auto" id="view">
  ...
  <footer id="footer" class="footer">
    ...
    <div class="credits">
      ...
      Designed by <a href="https://bootstrapmacom/">BootstrapMade</a>
    </div>
  </footer><!-- End Footer -->
