...
if(isset($_POST['updatestudent'])){
  ...
  $update_data = "UPDATE students SET firstname='$fname',lastname='$lname',adm_number='$adm',class='$class',phone='$phone',dateadded='$added_on' WHERE id='$id'";
...
if(isset($_POST['passchange'])){
  ...
  $passchange = "UPDATE students SET password='$newpass' WHERE id='$id'";
  ...
  <main id="main" class="main">
    ...
    <div class="row">
      ...
      ?>
          ...
          <div class="card col-sm-8" id="teacher">
            <div class="card-body">
      ...
      ?>
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="parent" value="<?php echo $row['parentname']; ?>">
                  </div>
                </div>
                <div class="row mb-3">
                  <label for="inputText" class="col-sm-2 col-form-label">ADM Number</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="admission" placeholder="t001-01/2023" maxlength="15" value="<?php echo $row['adm_number']; ?>">
                  </div>
                </div>
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <input type="number" class="form-control" name="phone" maxlength="10" minlength="10" value="<?php echo $row['phone']; ?>">
                  </div>
                </div>
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <input type="date" class="form-control" name="date" value="<?php echo $row['dateadded']; ?>">
                  </div>
                </div>
