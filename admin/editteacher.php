...
if(isset($_GET['type']) && $_GET['type']!=''){
  ...
  if($type=='status'){
    ...
    $update_status_sql="update teachers set status='$status' where id='$id'";
...
if(isset($_POST['updateteacher'])){
  $fname = mysqli_escape_string($conn,$_POST['fulname']);
  ...
  $update_data = "UPDATE teachers SET fullname='$fname',idnumber='$reg',phone='$phone',dateadd='$added_on',class='$class',email='$email',subject='$sub' WHERE id='$id'";
...
if(isset($_POST['passchange'])){
  ...
  $passchange = "UPDATE teachers SET password='$newpass' WHERE id='$id'";
    ...
    <section class="section">
      ...
      ?>
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <button type="submit" name="passchange" class="btn btn-danger">Change Password</button>
                  </div>
                </div>
            ...
            <div class="card-body">
              ...
              <form action="" method="POST">
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="fulname" value="<?php echo $row['fullname']?>">
                  </div>
                </div>
                <div class="row mb-3">
                  <label for="inputText" class="col-sm-2 col-form-label">ID Number</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="idnum" maxlength="8" value="<?php echo $row['idnumber']?>">
                  </div>
                </div>
                <div class="row mb-3">
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <input type="number" class="form-control" name="phone" value="<?php echo $row['phone']?>" maxlength="10" minlength="10">
                  </div>
                </div>
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <input type="date" class="form-control" name="date" value="<?php echo $row['dateadd']?>">
                  </div>
                </div>
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <select class="form-select" aria-label="Default select example" name="subj">
                      <option selected>Select subject</option>
                      <?php
                          $subsel = "SELECT * FROM subjects";
                          $selector = mysqli_query($conn,$subsel);
