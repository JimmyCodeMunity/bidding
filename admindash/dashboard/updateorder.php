...
if(isset($_POST['update'])){
  ...
  $update_data = "UPDATE category SET category='$foodcat' WHERE id='$id'";
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-3 px-1">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" required placeholder="" name="category" value="<?php echo $row['categoryname']?>">
                      </div>
                    </div>
