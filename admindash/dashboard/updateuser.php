...
if(isset($_POST['update'])){
  ...
  $update_data = "UPDATE userdata SET name='$fname',phone='$phone',email='$email' WHERE id='$id'";
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-3 px-1">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" required placeholder="" name="name" value="<?php echo $row['name']?>">
                      </div>
                    </div>
                    ...
                    <div class="col-md-3 px-1">
                      <div class="form-group">
                        <label>Email</label>
                        <input type="email" class="form-control" required placeholder="" name="email" value="<?php echo $row['email']?>">
                      </div>
                    </div>
