    ...
    <body>
        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-black">
            <div class="container px-4 px-lg-5">
                <a class="navbar-brand" href="#!">Bidders</a>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0 ms-lg-4">
                        ...
                        <li class="nav-item"><a class="nav-link" href="myorder.php">Won Bids</a></li>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <li><a class="dropdown-item" href="car.php">Cars</a></li>
                            <li><a class="dropdown-item" href="kitchen.php">Kitchenware</a></li>
