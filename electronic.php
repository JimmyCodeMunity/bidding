...
<?php
        ...
        $cat = $row['category'];
        $query_command = "SELECT * FROM product WHERE sold = '1' && category = 'Electronics' ";
    ...
    <?php
         ...
         echo '<div class="alert alert-danger" role="alert">No electronics to display</div>';
      }
...
<?php
        ...
        $cat = $row['category'];
        $query_command = "SELECT * FROM product WHERE sold = '0' && category = 'Electronics' ";
    ...
    <?php
         ...
         echo '<div class="alert alert-danger" role="alert">No Cars to display</div>';
      }
